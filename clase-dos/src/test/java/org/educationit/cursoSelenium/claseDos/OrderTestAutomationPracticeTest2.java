...
class OrderTestAutomationPracticeTest2 {
	...
	@Test
	@Order(1)
	void testSearchForShirt() throws InterruptedException {
		...
		try {
			...
			Thread.sleep(1000); // No es una buena practica, pero por ahora.....
	...
	@Test
	@Order(2)
	void testSearchForShit() throws InterruptedException {
